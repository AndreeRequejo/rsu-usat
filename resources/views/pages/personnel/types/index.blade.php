                        ...
                        <tr wire:key="personal-type-{{ $personalType->id }}"
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-end gap-2">
                                    <button wire:click="openEdit({{ $personalType->id }})" class="inline-flex h-8 w-8 items-center justify-center rounded-md text-[#F4C542] hover:bg-[#F4C542]/20 transition" title="Editar" aria-label="Editar">
                                    ...
                                    <button wire:click="confirmDelete({{ $personalType->id }})" class="inline-flex h-8 w-8 items-center justify-center rounded-md text-[#E53935] hover:bg-[#E53935]/20 transition" title="Eliminar" aria-label="Eliminar">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-5">
            <div class="flex items-start gap-4 px-6 pt-4">
                ...
                <div>
                    ...
                    <flux:text class="mt-1 text-sm text-[#666666]">¿Está seguro de que desea eliminar este tipo de personal? Esta acción no se puede deshacer.</flux:text>
                </div>
            </div>
